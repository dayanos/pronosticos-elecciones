...
const candidatos = [
    { nombre: "Franco parisi", foto: "images/pari.jpg" },
    { nombre: "Jeannette Jara", foto: "images/jara.jpg" },
    { nombre: "MEO", foto: "images/meo.jpg" },
    { nombre: "Johannes Kaiser", foto: "images/kai.jpg" },
    { nombre: "Jose Kast", foto: "images/kakas.jpg" },
    { nombre: "Eduardo Artes", foto: "images/arte.jpg" },
    { nombre: "Evelyn Matthei", foto: "images/mate.jpg" },
    { nombre: "Maicol", foto: "images/haro.jpg" }
];

// ✅ CONFIGURACIÓN CORREGIDA - VERIFICA ESTO
const AIRTABLE_CONFIG = {
    BASE_ID: 'appsQFN6YZHx5OAxH',  // ← SIN la I final
    API_KEY: 'TU_TOKEN_AQUI',      // ← TU TOKEN REAL
    TABLE_NAME: 'Table 1'          // ← EN INGLÉS
};

console.log('✅ CONFIGURACIÓN CORRECTA:', AIRTABLE_CONFIG);

// Inicializar la aplicación
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Aplicación iniciada con configuración corregida');
